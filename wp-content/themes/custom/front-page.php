...
<div class="welcome_content_wrapper">
		...
		<div
		    class="process_content">
				...
				<div class="process_one">
					...
					<h3 class="process_one_header">Snappy Process</h3>
					<p class="process_one_words">Our application process can be completed in minutes, not hours.Don't get stuck filing in tediou form.</p>
				</div>
				...
				<div class="process_two">
					...
					<h3 class="process_two_header">Affordable Prices</h3>
				...
				<div class="process_three">
					...
					<h3 class="process_three_header">People First</h3>
	...
	<div class="more_wrapper">
		<div class="more_content">
			...
			<h2 class="more_header">about how we work</h2>
		</div>
